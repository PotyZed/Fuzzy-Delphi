...
# creating data frame
df1 = pd.read_excel(r'C:/Users/p.zakeri/Desktop/first phase zed.xlsx')
mylist1 = []
...
X_l = np.zeros((count_row, 153))
X_m = np.zeros((count_row, 153))
X_u = np.zeros((count_row, 153))
...
dff.to_excel('final.xlsx')
dff2 = pd.DataFrame(M_l)
dff2.to_excel('first_l.xlsx')
dff3 = pd.DataFrame(M_m)
dff3.to_excel('first_m.xlsx')
dff4 = pd.DataFrame(M_u)
dff4.to_excel('first_u.xlsx')