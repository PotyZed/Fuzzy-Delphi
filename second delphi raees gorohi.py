...
# creating data frame
df1 = pd.read_excel(r'C:/Users/p.zakeri/Desktop/second phase zed.xlsx', sheet_name='raees')
...
dff.to_excel('raees.xlsx')
dff2 = pd.DataFrame(M_l)
dff2.to_excel('raees_l.xlsx')
dff3 = pd.DataFrame(M_m)
dff3.to_excel('raees_m.xlsx')
dff4 = pd.DataFrame(M_u)
dff4.to_excel('raees_u.xlsx')