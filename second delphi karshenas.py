...
# creating data frame
df1 = pd.read_excel(r'C:/Users/p.zakeri/Desktop/second phase zed.xlsx', sheet_name='karshenas')
...
dff.to_excel('karshenas.xlsx')
dff2 = pd.DataFrame(M_l)
dff2.to_excel('karshenas_l.xlsx')
dff3 = pd.DataFrame(M_m)
dff3.to_excel('karshenas_m.xlsx')
dff4 = pd.DataFrame(M_u)
dff4.to_excel('karshenas_u.xlsx')